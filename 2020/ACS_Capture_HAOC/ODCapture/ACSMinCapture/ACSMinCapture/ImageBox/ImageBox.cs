...
namespace Cyotek.Windows.Forms
{
  ...
  /// </summary>
    ...
    [Guid("2CF3D883-9AB0-42DD-80B9-90822EC50B6C")]
    ...
    public partial class ImageBox : ScrollableControl
    {
        ...
        public virtual void LoadFromFile(string FileName, bool ZoomToFit = true)
        {
            ...
            if (File.Exists(this.fileName))
            {
                ...
                using (var bmp = new Bitmap(this.fileName))
                {
                    ...
                    var FormatImage = CUtils.GetImageFormat(Path.GetExtension(this.fileName));

                    bmp.Save(ms, FormatImage);
        ...
        public virtual void Crop(CropState State)
        {
            ...
            switch (State)
            {
                ...
                case CropState.Crop:
                    {
                        Image _previewImage = new Bitmap((int)_selectionRegion.Width, (int)_selectionRegion.Height);

                        using (Graphics g = Graphics.FromImage(_previewImage))
                        {
                            g.DrawImage(this.Image, new RectangleF(0, 0, _selectionRegion.Width, _selectionRegion.Height), SelectionRegion, GraphicsUnit.Pixel);
                            g.Save();
                            g.Dispose();
                        }
        ...
        public virtual void Eraser(CropState State)
        {
                ...
                case CropState.Crop:
                    {
                        ...
                        g.FillRectangle(brush, new Rectangle(new Point((int)_selectionRegion.Location.X, (int)_selectionRegion.Location.Y), _selectionRegion.Size.ToSize()));
                        g.Save();
                        g.Dispose();
        ...
        public virtual bool SaveImageEdition { get; set; }
        ...
        Point _MousePositionInImage = new Point(0, 0);
        public Point MousePositionInImage { get { return _MousePositionInImage; } }
        ...
        protected virtual void ProcessPanning(MouseEventArgs e)
        {
            if (this.AutoPan && this.Image != null)
            {
                ...
                if (this.IsPanning)
                {
                    ...
                    _MousePositionInImage = new Point(x, y);
                    //this.UpdateScrollPosition(position);
                    this.UpdateScrollPosition(_MousePositionInImage);
                }
            }
        }
