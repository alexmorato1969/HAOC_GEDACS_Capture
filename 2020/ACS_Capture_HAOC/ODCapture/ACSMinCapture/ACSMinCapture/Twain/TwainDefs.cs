...
internal class TwSetupFileXFfer
{
    public TwSetupFileXFfer(string filename, ushort format)
    {
        FileName = filename;
        Format = format;
        VRefNum = 0xff;
    ...
    public ushort Format;   /* Any TWFF_ constant */
    public short VRefNum;  /* Used for Mac only  */
}
