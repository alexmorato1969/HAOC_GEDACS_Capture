...
{
    internal partial class WFSetArea : WFOk
    {
        ...
        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            ...
            var id =  idAreaSelecionada;
            ACSGlobal.idAreaSelecionada = Convert.ToInt16( id);

            //get label generic
            var labels = ACSMinCapture.DataBase.ACSDataBase.GetLabelGenerico(Convert.ToInt16(id));
