...
namespace ACSMinCapture.DataBase.ModelOracle
{
    ...
    public partial class GEDDOCUMENTOS1
    {
        public GEDDOCUMENTOS1()
        {
        ...
        public virtual GEDFORMATOS1 GEDFORMATOS { get; set; }
        public virtual GEDGRUPOSUSUARIOS1 GEDGRUPOSUSUARIOS { get; set; }
        public virtual GEDPASSAGENS1 GEDPASSAGENS { get; set; }
        public virtual GEDTIPOSDOCUMENTOS1 GEDTIPOSDOCUMENTOS { get; set; }
        public virtual GEDVOLUMES1 GEDVOLUMES { get; set; }
